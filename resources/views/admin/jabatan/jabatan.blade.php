                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30">Pengaturan jabatan untuk user</p>
                                ...
                                <table id="myTable2" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                              <a class="btn btn-lg btn-info fa fa-pencil" href="{{ route('admin.jabatan.edit',$datas->id)}}" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit Data"></a>
