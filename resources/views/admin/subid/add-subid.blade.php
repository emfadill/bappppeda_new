            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Tambah Data Sub Bidang</h4>
                    </div>
                    <!-- /.page title -->
                ...
                <div class="col-md-12">
                         <div class="white-box">
                            <h3 class="box-title m-b-0">Form Tambah Jabatan Sub Bidang</h3>
                            <p class="text-muted m-b-30 font-13"> Isi sesuai nama jabatan kepala sub bidang </p>
                             @if($errors->count() > 0)
                        ...
                        @endif
                            <form class="form-horizontal" method="POST" action="{{route('admin.subid.create')}}">
                                {{csrf_field()}}
