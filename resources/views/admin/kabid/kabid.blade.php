        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Data Kepala Bidang</h3>
                             <div class="pull-right">
                            <a href="{{route('admin.kabid.add')}}" class="btn btn-info waves-effect waves-light" type="button"><span class="btn-label"><i class="fa fa-plus-circle"></i>
                            </span>Tambah Kepala Bidang</a>
                            </div>
                            <p class="text-muted m-b-30">Pengaturan kepala bidang untuk user</p>
                                ...
                                <table id="myTable2" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                            <a class="btn btn-lg btn-info fa fa-pencil" href="{{ route('admin.kabid.edit',$datas->id)}}" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit Data"></a>
                ...
                .then((willDelete) => {
                    if (willDelete) {
                      $.ajaxSetup({
                        ...
                        jQuery.ajax({
                            url: "/konfigurasi-kabid/delete/"+ id,
                            method: 'delete',
