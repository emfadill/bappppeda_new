...
@section('title','Edit Data Kepala Bidang')
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Data Kepala Bidang</h4>
                    </div>
                    <!-- /.page title -->
                ...
                <div class="col-md-12">
                         <div class="white-box">
                            <h3 class="box-title m-b-0">Form Edit Kepala Bidang</h3>
                            <p class="text-muted m-b-30 font-13"> Isi form edit untuk mengubah nama jabatan kepala bidang. </p>
                             @if($errors->count() > 0)
                        ...
                        @endif
                            <form class="form-horizontal" method="POST" action="{{route('admin.kabid.update',$data->id)}}">
                                {{method_field('patch')}}
                                {{csrf_field()}}
